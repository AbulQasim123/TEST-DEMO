        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" name="gender" id="gender" required class="form-control" placeholder="Enter Gender">
                    </div>
                    <div class="form-group">
                        <input type="tel" name="mobile" id="mobile" required class="form-control" placeholder="Enter Mobile No">
                    </div>
                </div>
